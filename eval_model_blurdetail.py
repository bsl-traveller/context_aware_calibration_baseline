...
if __name__ == '__main__':
    ...
    writer = pd.ExcelWriter(os.path.join("results", "blur_detail_trained_seed.xlsx"), engine='xlsxwriter')

    for seed in SEEDS:
        #weights_file = os.path.join("model_weights", "resnet_110_10_blurdetail_u_" + str(seed) + ".h5")

        checkpoint_filepath = os.path.join("model_weights", "resnet_101_blurdetail_" + str(seed),
                                           "weights-blurdetail.h5")
        # load data
        ...
        for fil in filter_list:
            ...
            res = evaluate_model(checkpoint_filepath, x_test, y_test, bins=15, verbose=True,
                                 pickle_file="probs_resnet101_blurdetail_" + fil + "_" + str(seed), x_val=x_val,
